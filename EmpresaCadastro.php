            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="dashboard_graph">
                ...
                if ($RESULTADO_EMPRESA>"0"){
                    ...
                    $INSERE_EMPRESA ="INSERT INTO TB_EMPRESAS (EMP_EMPRESA,EMP_CNPJ,EMP_CNAE,EMP_ENDERECO) VALUES ('$EMPRESA_NOME','$EMPRESA_CNPJ','$EMPRESA_CNAE','$EMPRESA_ENDERECO')";
                        if (!mysqli_query($Conceta_Banco,$INSERE_EMPRESA))
                            {
                                die('Error: ' . mysql_error($Conceta_Banco));
                            }
                        echo "<div class='container'>
                                <div class='alert alert-success'>
                                    <strong>Obrigado!</strong> Empresa cadastrada com sucesso.
                                </div>
                            </div>";
                    }
                }?>
                ...
                <form method="post"  data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="form_empresa" name="form_empresa" placeholder="Nome da Empresa" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" maxlength="14" id="form_cnpj" placeholder="CNPJ" name="form_cnpj" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="int" id="form_cnae" placeholder="CNAE" name="form_cnae" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="form_endereco" placeholder="Informe o endereço da Empresa" name="form_endereco" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
						  ...
						  <button type="submit" name="CadastrarEmpresa" class="btn btn-success">Cadastrar</button>
                        </div>
                      </div>
